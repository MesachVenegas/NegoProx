    ...
    create: {
      ...
      userProfile: {
        create: {
          slug: 'MesachVenegas',
          profilePicture:
            'https://img.freepik.com/free-photo/young-businessman-wearing-blue-suit-standing-isolated-white-wall_231208-9847.jpg',
          bio: 'Administrador del sistema Negoprox',
